...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/Tjssh/TJ-PLUSSH/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/Tjssh/TJ-PLUSSH/main/badvpn/antcrashvpn.sh -o /dev/null
